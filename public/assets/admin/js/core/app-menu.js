...
(function(window, document, $) {
  ...
  $.app.menu = {
    ...
    change: function(defMenu) {
      ...
      // Initialize drill down menu for vertical dashboard, for horizontal dashboard drilldown menu is intitialized in changemenu function
    ...
    changeMenu: function(screen){
      ...
      if(screen == 'sm' || screen == 'xs'){
        ...
        // Intitialize drill down menu for horizontal dashboard
        // --------------------------------------------------
